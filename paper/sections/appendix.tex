...
The accompanying \texttt{literature\_screening/} directory contains six raw
OpenAlex query responses, 12 direct-title lookup responses, 280 unique
candidate records and a row-level screening ledger with exclusion reasons.
