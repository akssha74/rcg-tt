...
under resolution shift. It makes six contributions:
...
\item It prospectively replicates the anchor-matched protocol gap with a second
architecture and four fixed degradation operators across three seeds.
\item It performs a structured 12-work information-set scoping audit and
separates the concrete counterexample from any field-prevalence claim.
...
UAS/satellite and UAS/crewed-aircraft buildings from five held-out acquisitions
at four geographies and three disaster events, with independent model seeds and
